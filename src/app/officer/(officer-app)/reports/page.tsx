  ...
  return (
    <main className="min-h-full bg-[#f4f9f4] p-6">
      <header className="mb-6">
        <h1 className="text-3xl font-black text-gray-900">साप्ताहिक रिपोर्ट</h1>
        <p className="mt-1 text-base font-semibold text-gray-600">पिछले 7 दिनों में सेवा प्राप्त किसान</p>
      </header>

      <section className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
        <article className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 className="text-sm font-bold text-gray-600">इस सप्ताह कुल किसान</h2>
          <p className="mt-2 text-4xl font-black text-gray-900">341</p>
        </article>
        <article className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 className="text-sm font-bold text-gray-600">इस सप्ताह कुल खरीद मूल्य</h2>
          <p className="mt-2 text-4xl font-black text-gray-900">₹58.2 L</p>
        </article>
      </section>

      <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <h2 className="text-xl font-black text-gray-900">दैनिक किसान संख्या</h2>
        <p className="mt-1 text-sm font-semibold text-gray-600">पिछले 50 किसानों के औसत पर आधारित प्रतीक्षा-समय के साथ</p>
